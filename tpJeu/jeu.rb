class Personne
  ...
  def subit_attaque(degats_recus)
    ...
    sa = @points_de_vie.to_i - degats_recus.to_i
    @points_de_vie = sa
    # - Affiche ce qu'il s'est passé
...
class Joueur < Personne
  ...
  def soin
    # A faire
    # soigne aléatoirement de 20 a 50
    s = rand(50..100) + @points_de_vie
    # - Gagner de la vie
    if s > 100
      s = 100
    end
  ...
  def ameliorer_degats
    # A faire
    # amelioration des dégats aléatoirement de 10 à 30
    ad = rand(10..30) + @degats_bonus
    @degats_bonus = ad
...
100.times do |tour|
  ...
  # 99 qui veut dire "quitter" On quitte la boucle de jeu si on a choisi
  elsif choix == 99
    break
  else
